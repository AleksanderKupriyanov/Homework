...
public class Z2 {
    public static void main(String[] args){
       ...
       //Задание 1.
       long i,b=0; i=j;
            for (;i>0;){b=b*10+(i%10);i=i/10;}
                System.out.println("Число записанное справа налево: "+b);

       //Задание 2.
       long min,max=0; i=j; min=b%10;
            for (;i>0;i=i/10){b=i%10;
       ...
       int t=0; long c; i=j;
           for (;i>0;i=i/10){b=i%10;
               for (long a=i/10;a>0;a=a/10){c=a%10; if (c==b) t=1;}}
                   if (t!=1) System.out.println("true");

       //Задание 4.
       long k=0; max=0; i=j;
            for (;i>0;i=i/10){b=i%10;if (b>=max) max=b;} //Ищем максимум
       i=j;
            for (;i>0;i=i/10){b=i%10;if (b==max) k=k*10+b;} //Ищем повторяющие цифры максимума
       i=j*10;
